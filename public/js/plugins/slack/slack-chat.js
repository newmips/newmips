    ...
    var methods = {
        ...
        createChannel: function($elem, callback) {
            ...
            if(window.location.href.indexOf("https://") != -1)
                toSplit = "https://";
            var generatorURL = window.location.href.split(toSplit)[1].split("/")[0];
            var idApp = window.location.href.split("id_application=")[1] || 0;
            var privateChannelName = "help-"+generatorURL+"-"+idApp+"-"+(options.userId ? options.userId : (Math.random() * 100000));
