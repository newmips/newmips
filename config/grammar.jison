...
"set"                   return 'SET';
"belongs to"            return 'BELONGS_TO';
"has one"               return 'BELONGS_TO';
"has many"              return 'HAS_MANY';
//"as a list of"          return 'HAS_MANY';
//"has many to many"      return 'BELONGS_TO_MANY';
...
"appartient à"              return 'BELONGS_TO';
"a un"                      return 'BELONGS_TO';
...
instr :
  ...
  %}
  | CREATE ENTITY STRING BELONGS_TO STRING
  %{
      // Set target entity
      target = $5;
  ...
  %}
  | ENTITY STRING BELONGS_TO STRING
  %{
      // Set target entity
      target = $4;
  ...
  %}
  | ENTITY STRING BELONGS_TO STRING CALLED STRING
  %{
      // Set target entity
      target = $4;
